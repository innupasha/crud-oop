    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h1 class="h3 mb-0 text-gray-800">Mengedit Data</h1>
                ...
                <div class="card-body">
                  ...
                  <p><b>Nama Teman:</b></p>
                  <input class="form-control" type="text" name='nama' placeholder="Nama..." value="<?php echo $row['nama']; ?>" required>
                  </div>

                  <div class="col-md-5 col-sm-12 col-xs-12">
                  <p><b>Alamat:</b></p>
                  <input class="form-control" type="text" name='alamat' placeholder="Alamat..." value="<?php echo $row['alamat']; ?>" required>
                  </div>
                  </div>
                  ...
                  <div class="col-md-5 col-sm-12 col-xs-12">
                  <p><b>Umur:</b></p>
                  <input class="form-control" type="number" name='nomor' placeholder="Nomor Handphone..." value="<?php echo $row['nomor']; ?>" required>
                  </div>
